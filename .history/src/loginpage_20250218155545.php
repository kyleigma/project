...
<style>
    ...
    .background {
        ...
        width: 100%;
        height: 100%;
        background: url('images/logbg.svg') no-repeat center center fixed;
...
<body>
    <div class="background"></div> <!-- Background Image Layer -->
    <div class="blurred-background"></div> <!-- Blurred Effect Layer -->
