...
<?php include 'includes/session.php'; ?>
  ...
  <body>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800 mb-3">Implemented Aklan Free WiFi Sites &nbsp;&nbsp;|&nbsp;&nbsp;<b>UISGIDA</b></h1>
            ...
            <table class="table responsive table-striped datatable">
                ...
                <?php
                    ...
                    fp.name AS project_name, fw.status, m.name AS municipality_name
                            ...
                            WHERE fw.project_id IN (7, 'UISGIDA')
    ...
    function getRow(id) {
      $.ajax({
        type: 'POST',
        url: 'uisgida_row.php', // Ensure this file exists and fetches the data
        data: {id:id},
        dataType: 'json',
