...
<?php include 'includes/session.php'; ?>
  ...
  <body>
        ...
        <div class="main-panel">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <div class="ml-auto">
                    <a href="region_initiated_print.php" target="_blank" class="btn btn-md btn-primary btn-flat" style="margin-left: 2rem;">
                        <i class="mdi mdi-printer-outline"></i> Print
                    </a>
                    <a href="region_initiated_excel.php" class="btn btn-md btn-primary btn-flat">
    ...
    <!-- container-scroller -->
    <?php include 'includes/region_initiated_modal.php';?>
