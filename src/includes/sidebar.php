<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    ...
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="collapse" href="#utilities" aria-expanded="false" aria-controls="utilities">
        <i class="menu-icon mdi mdi-cash-multiple"></i>
        <span class="menu-title">Utilities</span>
        <i class="menu-arrow"></i>
      </a>
      <div class="collapse" id="utilities" data-bs-parent="#sidebar">
        <ul class="nav flex-column sub-menu">
    ...
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="collapse" href="#user-accounts" aria-expanded="false" aria-controls="user-accounts">
        <i class="menu-icon mdi mdi-account-group"></i>
        <span class="menu-title">User Accounts</span>
        <i class="menu-arrow"></i>
      </a>
      <div class="collapse" id="user-accounts" data-bs-parent="#sidebar">
        <ul class="nav flex-column sub-menu">
