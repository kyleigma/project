...
<?php include 'includes/session.php'; ?>
  ...
  <body>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800 mb-3">Implemented Aklan Free WiFi Sites &nbsp;&nbsp;|&nbsp;&nbsp;<b>WITS</b></h1>
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <div class="ml-auto">
                    <a href="wits_print.php" target="_blank" class="btn btn-md btn-primary btn-flat" style="margin-left: 2rem;">
                        <i class="mdi mdi-printer-outline"></i> Print
                    </a>
                    <a href="wits_excel.php" class="btn btn-md btn-primary btn-flat">
    ...
    function getRow(id) {
      $.ajax({
        type: 'POST',
        url: 'wits_row.php', // Ensure this file exists and fetches the data
        data: {id:id},
        dataType: 'json',
