...
<?php include 'includes/session.php'; ?>
  ...
  <body>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Implemented Aklan Free WiFi Sites - WITS</h1>
                <nav style="font-size:85%;" aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class=""><i class="mdi mdi-menu-right"></i></li>&nbsp;&nbsp;&nbsp;
                        <li class="active" aria-current="page">WITS</li>
                    </ol>
                </nav>
            </div>
            <?php
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <a href="wits_print.php" target="_blank" class="btn btn-md btn-primary btn-flat mr-2">
            ...
            <table class="table responsive table-striped datatable">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT * FROM libacao ORDER BY priority ASC";
                    $query = $conn->query($sql);
                    while($row = $query->fetch_assoc()){
                      echo "
                        <tr>
                          <td class='hidden'></td>
                          <td>".$row['projectname_wits']."</td>
                          <td>".$row['barangay_wits']."</td>
                          <td>".$row['project_8']."</td>
                          <td>".$row['aps_wits']."</td>
                          <td width='50'>
    ...
    <!-- container-scroller -->
    <?php include 'includes/wits_modal.php';?>
    ...
    function getRow(id) {
      ...
      function getRow(id){
        $.ajax({
          ...
          $('.id').val(response.id);
          $('#edit_projectname_wits').val(response.projectname_wits);
          $('#edit_barangay_wits').val(response.barangay_wits);
          $('#edit_project_8').val(response.project_8);
          $('#edit_aps_wits').val(response.aps_wits);
          $('.projectname_wits').html(response.projectname_wits);
          }
        });
      }
    </script>
