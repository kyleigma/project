...
<?php include 'includes/session.php'; ?>
  ...
  <body>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800 mb-3">Implemented Aklan Free WiFi Sites &nbsp;&nbsp;|&nbsp;&nbsp;<b>MIS Aklan</b></h1>
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <div class="ml-auto">
                    <a href="mis_aklan_print.php" target="_blank" class="btn btn-md btn-primary btn-flat" style="margin-left: 2rem;">
                        <i class="mdi mdi-printer-outline"></i> Print
                    </a>
                    <a href="mis_aklan_excel.php" class="btn btn-md btn-primary btn-flat">
            ...
            <table class="table responsive table-striped datatable">
                ...
                <?php
                    ...
                    fp.name AS project_name, fw.status, m.name AS municipality_name
                            ...
                            WHERE fw.project_id IN (2, 'MIS Aklan')
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      echo "
                        <tr>
                          ...
                          <td class='text-center'><span class='badge rounded-pill $statusBadge' style='font-size: 0.75rem;'>".ucfirst($row['status'])."</span></td>
    ...
    function getRow(id) {
      $.ajax({
        type: 'POST',
        url: 'mis_aklan_row.php', // Ensure this file exists and fetches the data
        data: {id:id},
        dataType: 'json',
