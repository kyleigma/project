...
<?php
    ...
    $query_room = mysqli_query($conn,"SELECT * FROM altavas ORDER BY priority ASC");
    ...
    while($rooms=mysqli_fetch_array($query_room)){
        ...
        $room = $rooms['projectname_altavas'];
        $desc = $rooms['locality_altavas'];
        $address = $rooms['address_project'];
        $room1 = $rooms['aps_altavas'];
