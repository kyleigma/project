...
<?php
    ...
    $query_room = mysqli_query($conn,"SELECT * FROM batan ORDER BY priority ASC");
    ...
    while($rooms=mysqli_fetch_array($query_room)){
        ...
        $room = $rooms['projectname_batan'];
        $desc = $rooms['barangay_batan'];
        $address = $rooms['project_2'];
        $room1 = $rooms['aps_batan'];
