...
<?php
    ...
    $query_room = mysqli_query($conn,"SELECT * FROM libacao ORDER BY priority ASC");
    ...
    while($rooms=mysqli_fetch_array($query_room)){
        ...
        $room = $rooms['projectname_wits'];
        $desc = $rooms['barangay_wits'];
        $address = $rooms['project_8'];
        $room1 = $rooms['aps_wits'];
