...
<?php
    ...
    $query_room = mysqli_query($conn,"SELECT * FROM banga ORDER BY priority ASC");
    ...
    while($rooms=mysqli_fetch_array($query_room)){
        ...
        $room = $rooms['projectname_banga'];
        $desc = $rooms['barangay_banga'];
        $address = $rooms['project_3'];
        $room1 = $rooms['aps_banga'];
