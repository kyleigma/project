    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="home-tab">
                ...
                <!-- Bills Section -->
                <div class="row g-3" id="bills-section">
                    <!-- Monthly Bills Card -->
                    <div class="card card-rounded col-12 mb-4">
                        <div class="card-body">
                    ...
                    <div class="card card-rounded col-12 col-lg-6 mb-4">
                        <div class="card-body">
                ...
                <div class="row g-3" id="charts-section">
