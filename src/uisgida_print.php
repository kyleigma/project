...
<?php
    ...
    $query_room = mysqli_query($conn,"SELECT * FROM kalibo ORDER BY priority ASC");
    ...
    while($rooms=mysqli_fetch_array($query_room)){
        ...
        $room = $rooms['projectname_uisgida'];
        $desc = $rooms['barangay_uisgida'];
        $address = $rooms['project_6'];
        $room1 = $rooms['aps_uisgida'];
