...
<?php
    ...
    $query_room = mysqli_query($conn,"SELECT * FROM ibajay ORDER BY priority ASC");
    ...
    while($rooms=mysqli_fetch_array($query_room)){
        ...
        $room = $rooms['projectname_ibajay'];
        $desc = $rooms['barangay_ibajay'];
        $address = $rooms['project_5'];
        $room1 = $rooms['aps_ibajay'];
